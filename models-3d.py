...
class SdcModel(object):
    ...
    def create(cls, creation_args):
        ...
        layer = Convolution3D(80, 3, 3, 3, init="he_normal", activation="relu", border_mode="same")(layer)
        layer = MaxPooling3D((2, 3, 3))(layer)
        layer = SpatialDropout3D(0.5)(layer)
        layer = BatchNormalization(axis=4)(layer)
        ...
        layer = Convolution3D(240, 3, 3, 3, init="he_normal", activation="relu", border_mode="same")(layer)
        layer = SpatialDropout3D(0.5)(layer)
        layer = BatchNormalization(axis=4)(layer)
        layer = Flatten()(layer)
...
def main():
    ...
    train_model({
        "dataset_path": "/home/nalapati/udacity/sdc/udacity-p3/datasets/dataset_9",
